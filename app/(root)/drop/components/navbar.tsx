      ...
      <nav className="flex justify-between items-center max-w-screen xl:mx-auto z-50">
        ...
        <div className="w-1/4 flex gap-3 md:gap-8">
          <button onClick={() => setSidebarOpen(true)}>
            <HamburgerIconSvg className="w-5 h-5 text-white hover:text-white/80"/>
          </button>
          ...
          <div className="sm:hidden">
            ...
            <button
              ...
              className="flex items-center gap-1.5 border-none bg-transparent cursor-pointer text-white hover:text-white/80 transition duration-200"
            >
              <SearchIconSvg className="w-5 h-5 text-white hover:text-white/80" />
            </button>
          </div>
        </div>
        ...
        <Link href="/" className="w-1/2 items-center flex justify-center">
          <h1 className="text-4xl md:text-5xl font-medium text-white">Enunas</h1>
        </Link>
        ...
        <div className="flex gap-3 md:gap-8 mt-3 text-base w-1/4 justify-end">
          ...
          <div>
            <button className="cursor-pointer">
              <AccountIconSvg className="w-5 h-5 text-white hover:text-white/80"/>
            </button>
          </div>

          <div>
            <button className="relative cursor-pointer hidden sm:block">
              <HeartIconSvg className="w-5 h-5 text-white hover:text-white/80"/>
          ...
          <div>
            <button className="relative cursor-pointer">
              <CartIconSvg className="w-5 h-5 text-white hover:text-white/80"/>
              <span className={ICON_BADGE_CLASSES}>0</span>
            </button>
          </div>
        </div>
