...
export default function ShippingForm({ initialData, onNext }: ShippingFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="animate-fade-in-up">
      <h2 className="font-cormorant text-2xl text-enunas-black mb-8">Lieferadresse</h2>
      ...
      <div className="mt-10">
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 py-4 border border-enunas-gray-light bg-white hover:bg-enunas-off-white transition-colors duration-200 ease-out-expo"
        >
        ...
        <div className="flex items-center gap-4 my-4">
          ...
          <span className="font-league-spartan text-[11px] uppercase tracking-[0.2em] text-enunas-gray-medium">oder</span>
          <div className="flex-1 h-px bg-enunas-gray-light" />
        </div>
      </div>
      ...
      <button
        type="submit"
        className="w-full py-4 bg-enunas-purple text-white font-league-spartan text-sm tracking-[0.15em] uppercase hover:bg-enunas-purple-light transition-colors duration-200 ease-out-expo"
      >
        Weiter zur Zahlung →
      </button>
    </form>
