...
interface ProductCardProps {
  item: RecItem;
  /** Image aspect-ratio: '3/4' (default) or '1/1' for the look mini cards */
  aspect?: '3/4' | '1/1' | '4/3';
  /** Smaller typography variant for compact placements */
  compact?: boolean;
}

/**
 * Compact product card used inside the three recommendation rows
 * (Vervollständige den Look / Mehr von der Marke / Ähnliche Produkte).
 *
 * Renders a tinted silhouette placeholder when `image` is omitted —
 * keep this for the mockup, swap in <Image> once you have real assets.
 */
...
/* ---------- Category silhouette placeholders ---------- */
