interface CatalogueTagsProps {
  /** Array of category names, e.g. ["Experimental", "Culture", "Star"]. Null shows fallback. */
...
/**
 * 3 fixed-width Cormorant-serif tags with a 1px black border.
 * When `categories` is null, falls back to a sensible default so the
