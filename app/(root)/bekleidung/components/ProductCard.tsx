...
const products = [
  {
    ...
    colourname: "red",
    price: "220€",
    href: `/bekleidung/schuhe/${generateSlug("nike air shoes 5")}`
  },
  {
    ...
    colourname: "purple",
    price: "220€",
    href: `/bekleidung/jacken/${generateSlug("Worlds End Denim Boxer Jacket")}`
  },
  {
  ...
  },
  {
    ...
    colourname: "black",
    price: "220€",
    href: `/bekleidung/oberteile/${generateSlug("Produktbeschreibung random blabalba")}`
  }
]
