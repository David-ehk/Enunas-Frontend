...
const sections: LegalSection[] = [
  {
    ...
    paras: [
      ['Diensteanbieter', 'David Emmanuel Hod Konan (Einzelunternehmen „Enunas")', 'Appenzellerstr. 113, 81475 München, Deutschland'],
    ],
  },
  {
  ...
  {
    id: 'ustid', num: '03', label: 'Umsatzsteuer-ID', title: 'Umsatzsteuer',
    paras: [
      'Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:',
      ['USt-IdNr.', 'DE463881719'],
    ],
  },
  {
    id: 'os', num: '04', label: 'EU-Streitschlichtung', title: 'Online-Streitbeilegung',
    paras: [
  ...
  {
    id: 'inhalte', num: '05', label: 'Haftung für Inhalte', title: 'Haftung für Inhalte',
    paras: [
  ...
  {
    id: 'links', num: '06', label: 'Haftung für Links', title: 'Haftung für Links',
    paras: [
  ...
  {
    id: 'urheberrecht', num: '07', label: 'Urheberrecht', title: 'Urheberrecht',
    paras: [
