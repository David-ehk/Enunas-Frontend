    ...
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-0">
        {geschlecht.map((ges, idx) => (
          <div className="relative group h-[70vh] sm:h-screen" key={idx}>
            <Link href={ges.link}>
              {/* Titel */}
              <div className="sticky flex justify-center top-0 z-10 p-6 pt-5">
