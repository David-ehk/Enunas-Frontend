...
const products = [{
  imgURL: "https://www.manieredevoir.com/cdn/shop/files/GEN-WD-23-10-2025.jpg?crop=center&height=2095&v=1761206881&width=1920",
    ...
    colourname: "red",
    price: "220€",
    href: `/bekleidung/schuhe/${generateSlug("nike air shoes 5 auch hier richtig lange ohne Grund")}`
  },
  {
    ...
    colourname: "purple",       
    price: "220€",
    href: `/bekleidung/jacken/${generateSlug("Worlds End Denim Boxer Jacket einfach zum test blablabla")}`
  },
  {
    ...
    colourname: "white",      
    price: "220€",
    href: `/bekleidung/jacken/${generateSlug("D.D. Shell hooded-padded jacket")}`
  },
  {
    ...
    colourname: "black",
    price: "220€",
    href: `/bekleidung/oberteile/${generateSlug("Produktbeschreibung random blabalba soll richtig lange sein")}`
  }
];
